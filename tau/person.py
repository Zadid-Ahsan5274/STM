...
class Person:
    ...
    def status_change(self):
        if self.health == 100:
            print("{} is totally heathy!".format(self.firstname))
        elif self.health >=76:
...
class Enemy(Person):
    def __init__(self,weapon,firtname,lastname,health,status):
        super.__init__(firtname,lastname,health,status)
        self.weapon = weapon
    def hurt(self,other):
        if self.weapon == "rock":
            other.health -= 10
